...
public class CurveFrame extends CgApplication {
	...
	private ICurve addBezierCurve() {
		...
		curve.setControlPoint(1,
				VectorMatrixFactory.newIVector3(-0.25, 0.5, -0.5));
	...
	private ICurve addHermiteCurve() {
		ICurve curveHermite = new HermiteCurve(VectorMatrixFactory.newIVector3(
				-0.5, -0.5, 0), VectorMatrixFactory.newIVector3(-0.5, 0.5, 0),
	...
	private ICurve addPolynomialCurve() {
		...
		curvePolynomial.setControlPoint(0,
				VectorMatrixFactory.newIVector3(-0.5, -0.5, 0.5));
		curvePolynomial.setControlPoint(1,
				VectorMatrixFactory.newIVector3(0, 0.5, 0));
		curvePolynomial.setControlPoint(2,
				VectorMatrixFactory.newIVector3(0.5, -0.5, 0.5));
		CgNode curveNode = new CgNode(curvePolynomial,
				"Polynomial (Monom) Curve");
		curveNode.setVisible(false);
		getCgRootNode().addChild(curveNode);
