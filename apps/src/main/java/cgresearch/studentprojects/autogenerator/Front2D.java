...
public class Front2D {
	...
	public Front2D(IVector3 center, double hoehe, double laenge, int degree,
	...
	public void setLeft(int fronth, int frontv, IVector3... points) {
...
//						+ x
	...
	public void setTop(int fronth, int frontv, IVector3... points) {
		...
		curve.setControlPoint(
				1,
				VectorMatrixFactory.newIVector3(points[0].get(0) + 2*x,
						points[0].get(1) - y, 0));
	...
	public void setRight(IVector3... points) {
