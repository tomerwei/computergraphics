...
public class RightBottomWing {
	...
	public RightBottomWing(IVector3 center, double hoehe, double laenge, double wingMitteBreite) {
	...
	public void setRight() {
		...
		curve.setControlPoint(1, VectorMatrixFactory.newIVector3(D.get(0) + 0.2, D.get(1) + hoehe / 2, 0));
