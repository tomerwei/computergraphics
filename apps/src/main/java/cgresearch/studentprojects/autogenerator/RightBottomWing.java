...
public class RightBottomWing {
	...
	public RightBottomWing(Vector center, double hoehe, double laenge, double wingMitteBreite, double bwlrh,
			double bwlrv, double bwbh, double bwbv, double bwtph, double bwtpv, double bwb2h, double bwb2v,
	...
	public void setRight(double bwlrh, double bwlrv, double bwtph, double bwtpv, double bwlr2h, double bwlr2v) {
		...
		curve.setControlPoint(3, VectorMatrixFactory.newVector(D.get(0) + bwtph, D.get(1) + bwtpv, 0));

		curve.setControlPoint(2, VectorMatrixFactory.newVector(D.get(0) + bwlr2h, D.get(1) + offset + bwlr2v, 0));

		curve.setControlPoint(1, VectorMatrixFactory.newVector(D.get(0) + bwlrh, D.get(1) + hoehe / 2 + bwlrv, 0));

		curve.setControlPoint(0, VectorMatrixFactory.newVector(C.get(0), C.get(1), 0));
	...
	public void setBottom(double wingMitteBreite, double bwbh, double bwbv, double bwtph, double bwtpv, double bwb2h,
			double bwb2v) {
		...
		curve.setControlPoint(3, VectorMatrixFactory.newVector(B.get(0), B.get(1) - breite, 0));

		curve.setControlPoint(2, VectorMatrixFactory.newVector(A.get(0) + bwbh, A.get(1) + bwbv, 0));

		curve.setControlPoint(1, VectorMatrixFactory.newVector(D.get(0) + offset + bwb2h, D.get(1) + bwb2v, 0));

		curve.setControlPoint(0, VectorMatrixFactory.newVector(D.get(0) + bwtph, D.get(1) + bwtpv, 0));
