 ...
 * input types are allowed.  See {@link cgresearch.studentprojects.brickbuilder.externalimageiotga.TGAImageReader}
...
public class TGAImageReaderSpi extends ImageReaderSpi
{
    ...
    public TGAImageReaderSpi()
    {
        super(VENDOR_NAME, VERSION, FORMAT_NAMES, SUFFIXES, MIME_TYPES, 
              READER_CLASSNAME,
              new Class[] { ImageInputStream.class }, // Deprecated: ImageReaderSpi.STANDARD_INPUT_TYPE
