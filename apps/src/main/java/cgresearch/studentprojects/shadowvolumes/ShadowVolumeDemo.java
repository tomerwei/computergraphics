...
public class ShadowVolumeDemo extends CgApplication {
    ...
    private void loadScene() {
        ...
        // Set light source
        LightSource lightSource = new LightSource(LightSource.Type.POINT);
        lightSource.setPosition(VectorMatrixFactory.newIVector3(0,10,2));
    ...
    private void createEnvironment() {
        ...
        new CgTexture("textures/android.png"));
