...
public class RuleTree extends SimpleTree<GrammarRule>{
	...
	/**
	 * Create The Tree 
	 * @param rootDataList Map of String GrammarRule Pairs
	...
	private void addNodeToRuleTree(Node<GrammarRule> node, IRulenameValuePair ruleValuePair,Map<String,GrammarRule> rootDataList){
