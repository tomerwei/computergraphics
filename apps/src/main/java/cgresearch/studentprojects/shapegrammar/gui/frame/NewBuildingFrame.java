...
public class NewBuildingFrame extends JFrame implements ActionListener {
	 ...
	 */
	public NewBuildingFrame(CgRootNode rootNode) {
		super("New Building");
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equals(NewBuildingFrame.ACTION_COMMAND_CREATE)) {
			try {
				...
				CgNode node = buildingGenerator.generateBuildingCgNode(buildingDir, doubleWidth, doubleHeight,
						doubleLength, doubleX, doubleZ);
				setVisible(false);
