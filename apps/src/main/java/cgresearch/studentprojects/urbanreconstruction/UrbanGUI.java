...
public class UrbanGUI extends IApplicationControllerGui {
  ...
  public UrbanGUI() {
    ...
    ran = new Ransac(Integer.parseInt(supportT.getText()), Double.parseDouble(TresholdT.getText()));
  }
  ...
  private void showPlains() {
    ...
    xyz.addPoint(new Point(new Vector(0, 0, 0), new Vector(3), new Vector(3)));
    xyz.addPoint(new Point(new Vector(0, 1, 0), new Vector(3), new Vector(3)));
    xyz.addPoint(new Point(new Vector(0, 2, 0), new Vector(3), new Vector(3)));
    xyz.addPoint(new Point(new Vector(0, 3, 0), new Vector(3), new Vector(3)));
    xyz.addPoint(new Point(new Vector(0, 4, 0), new Vector(3), new Vector(3)));
    xyz.addPoint(new Point(new Vector(0, 5, 0), new Vector(3), new Vector(3)));
    xyz.addPoint(new Point(new Vector(0, 6, 0), new Vector(3), new Vector(3)));
    xyz.addPoint(new Point(new Vector(0, 7, 0), new Vector(3), new Vector(3)));
    xyz.addPoint(new Point(new Vector(0, 8, 0), new Vector(3), new Vector(3)));
    xyz.addPoint(new Point(new Vector(0, 9, 0), new Vector(3), new Vector(3)));
    xyz.addPoint(new Point(new Vector(0, 10, 0), new Vector(3), new Vector(3)));
    xyz.addPoint(new Point(new Vector(1, 0, 0), new Vector(3), new Vector(3)));
    xyz.addPoint(new Point(new Vector(2, 0, 0), new Vector(3), new Vector(3)));
    xyz.addPoint(new Point(new Vector(3, 0, 0), new Vector(3), new Vector(3)));
    xyz.addPoint(new Point(new Vector(4, 0, 0), new Vector(3), new Vector(3)));
    xyz.addPoint(new Point(new Vector(5, 0, 0), new Vector(3), new Vector(3)));
    xyz.addPoint(new Point(new Vector(6, 0, 0), new Vector(3), new Vector(3)));
    xyz.addPoint(new Point(new Vector(7, 0, 0), new Vector(3), new Vector(3)));
    xyz.addPoint(new Point(new Vector(8, 0, 0), new Vector(3), new Vector(3)));
    xyz.addPoint(new Point(new Vector(9, 0, 0), new Vector(3), new Vector(3)));
    xyz.addPoint(new Point(new Vector(10, 0, 0), new Vector(3), new Vector(3)));
    xyz.addPoint(new Point(new Vector(0, 0, 1), new Vector(3), new Vector(3)));
    xyz.addPoint(new Point(new Vector(0, 0, 2), new Vector(3), new Vector(3)));
    xyz.addPoint(new Point(new Vector(0, 0, 3), new Vector(3), new Vector(3)));
    xyz.addPoint(new Point(new Vector(0, 0, 4), new Vector(3), new Vector(3)));
    xyz.addPoint(new Point(new Vector(0, 0, 5), new Vector(3), new Vector(3)));
    xyz.addPoint(new Point(new Vector(0, 0, 6), new Vector(3), new Vector(3)));
    xyz.addPoint(new Point(new Vector(0, 0, 7), new Vector(3), new Vector(3)));
    xyz.addPoint(new Point(new Vector(0, 0, 8), new Vector(3), new Vector(3)));
    xyz.addPoint(new Point(new Vector(0, 0, 9), new Vector(3), new Vector(3)));
    xyz.addPoint(new Point(new Vector(0, 0, 10), new Vector(3), new Vector(3)));
