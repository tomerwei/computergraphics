...
public class FrustumTestFrame extends CgApplication {
  ...
  public FrustumTestFrame() {
    ...
    ITriangleMesh dragon = reader.readFile("meshes/dragon_vrip_res3.ply");
     ...
     TriangleMeshTransformation.scale(cow, 10.0);
     ...
     VectorFactory.createVector3(10.5, 0.0, 0.0));
     ...
     TriangleMeshTransformation.translate(dragon,
     VectorFactory.createVector3(0.5, 0.0, 22.0));
     ...
     getCgRootNode().addChild(new CgNode(bunnyUp, "bunnyOne"));
     getCgRootNode().addChild(new CgNode(pumpkin, "pumpkin"));
     getCgRootNode().addChild(new CgNode(bunnyDown, "bunnyTwo"));
     getCgRootNode().addChild(new CgNode(bunnyUp1, "bunnyThree"));
...
//    getCgRootNode().addChild(new CgNode(bunny29, "bunny29"));
  ...
  public static void main(String[] args) {
    ...
    if ((!app.getCgRootNode().useViewFrustumCulling()) && viewFrustumCullingTest) {
      ViewFrustumCulling vfc = new ViewFrustumCulling(app.getCgRootNode());
...
//      System.out.println("SECONDS = " + watch.getSeconds());
...
//    watch.stop();
    System.out.println("SECONDS = " + watch.getSeconds());
//    
//    Camera.getInstance().setEye(new Vector(5,3,2));
//    try {
//      Thread.sleep(2000);
//    } catch (InterruptedException e) {
//      // TODO Auto-generated catch block
...
//    }
//    
//    Camera.getInstance().setEye(new Vector(-2,5,3.3));
//    try {
//      Thread.sleep(2000);
//    } catch (InterruptedException e) {
//      // TODO Auto-generated catch block
...
//    }
//    
//    Camera.getInstance().setEye(new Vector(-10,7,5));
//    try {
//      Thread.sleep(2000);
//    } catch (InterruptedException e) {
//      // TODO Auto-generated catch block
