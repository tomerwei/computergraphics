...
public class FrustumTestFrame extends CgApplication {
    ...
    public FrustumTestFrame() {
        ...
        TriangleMeshTransformation.translate(bunny,
                VectorMatrixFactory.newIVector3(0.0, 0.0 /* 1.15 */, 9.0));
        ...
        TriangleMeshTransformation.translate(bunnyDown, VectorMatrixFactory.newIVector3(0.0, 0.0, -8.0));
        TriangleMeshTransformation.scale(bunnyUp, 3.0);
        TriangleMeshTransformation.translate(bunnyUp, VectorMatrixFactory.newIVector3(0.0, 2.0, 0.5));
        TriangleMeshTransformation.scale(pumpkin, 0.02);
        TriangleMeshTransformation.translate(pumpkin, VectorMatrixFactory.newIVector3(0.0, 0.0, 23.5));
        // // ############### Transformationen ###############
        //
    ...
    public static void main(String[] args) {
        ...
        if (!rootNode.useViewFrustumCulling()) {
            ViewFrustumCulling vfc = new ViewFrustumCulling(Camera.getInstance(),
                    Camera.getInstance().getNearClippingPlane(), Camera.getInstance().getFarClippingPlane(), rootNode);
//                    0.0, 230, rootNode);
