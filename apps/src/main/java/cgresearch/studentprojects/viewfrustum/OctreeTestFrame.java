...
//    System.out.println("BB BUNNDYDOWN VORHER = " + bunnyDown.getBoundingBox());
    TriangleMeshTransformation.scale(bunnyDown, 5.0);
...
//    System.out.println("BB BUNNY VORHER = " + bunny.getBoundingBox());
    TriangleMeshTransformation.scale(bunny, 5.0);
...
//    System.out.println("BB BUNNYUP VORHER = " + bunnyUp.getBoundingBox());
    TriangleMeshTransformation.scale(bunnyUp, 5.0);
...
//    getCgRootNode().addChild(new CgNode(bunny29, "bunny29"));
  ...
  public void printOctreeNodesWithContent(OctreeNode<Integer> octreeScene){
    ...
    if(elements > 0 && children == 0){
      getCgRootNode().addChild(new CgNode(octreeScene, "os"));
    }
    if(children > 0 && elements == 0){
