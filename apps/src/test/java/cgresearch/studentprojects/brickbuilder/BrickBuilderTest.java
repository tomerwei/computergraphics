...
public class BrickBuilderTest extends CgApplication {
  ...
  public static void main(String[] args) {
    ...
    registry
        .registerServiceProvider(new cgresearch.studentprojects.brickbuilder.externalimageiotga.TGAImageReaderSpi());

    ResourcesLocator.getInstance()
        .addPath("C:\\Users\\Teetasse\\Desktop\\Bachelorarbeit\\GIT-Projekte\\cg\\resources\\");
    ResourcesLocator.getInstance()
        .addPath("C:\\Users\\Teetasse\\Desktop\\Bachelorarbeit\\GIT-Projekte\\cg_brickbuilder\\resources\\");
  ...
  public BrickBuilderTest() {
    ...
    ITriangleMesh yoshi = new ObjFileReader().readFile("meshes/yoshiPirate.obj").get(0);
  ...
  // IVoxelCloud cloud = VoxelCloudReader.readFromFile("___cube-50_0.vox"); //
  // voxelclouds/legoMan
