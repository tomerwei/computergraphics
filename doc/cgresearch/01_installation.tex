...
Wir beginnen mit dem Schnelleinstieg. Zunächst müssen auf dem Rechner die Voraussetzungen sichergestellt:
\begin{itemize}
...
\begin{itemize}
	\item \textbf{Auschecken des Repositories:} Das Repository mit allen notwendigen Sourcen und sonstigen Dateien finden sich unter folgendes URL: \\
	...
	\begin{itemize}
		...
		\item Select root directory: <Hier muss das Unterverzeichnis \emph{apps} ausgewählt werden>
		\item Finish
	\end{itemize}
