...
Die Rendering-Systeme werden ausführlicher in Abschnitt \ref{sec:rendering} besprochen. Prinzipiell lauffähige Systeme, die aber deutlich weniger Integration in die bestehenden Datenstrukturen haben, sind jMonkey und libGDX.
