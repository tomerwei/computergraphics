...
public class VectorMatrixFactory {
	 ...
	 * @return new instance.
	 */
	public static IMatrix3 newIMatrix3(IVector3 row0, IVector3 row1,
			IVector3 row2) {
	 ...
	 * Create a new instance of a 3x3-matrix.
	 */
	public static IMatrix3 newIMatrix3(double v00, double v01, double v02,
			double v10, double v11, double v12, double v20, double v21,
			double v22) {
	 ...
	 * @return new instance.
	 */
	public static IMatrix4 newIMatrix4(IVector4 row0, IVector4 row1,
			IVector4 row2, IVector4 row3) {
	...
	public static IMatrix3 getRotationMatrix(IVector3 axis, double angle) {
		...
		return new Matrix3(VectorMatrixFactory.newIVector3(t * axis.get(0)
				* axis.get(0) + c,
				t * axis.get(0) * axis.get(1) + s * axis.get(2),
				t * axis.get(0) * axis.get(2) - s * axis.get(1)),
				VectorMatrixFactory.newIVector3(t * axis.get(0) * axis.get(1)
						- s * axis.get(2), t * axis.get(1) * axis.get(1) + c, t
						* axis.get(1) * axis.get(2) + s * axis.get(0)),
				VectorMatrixFactory.newIVector3(t * axis.get(0) * axis.get(2)
						+ s * axis.get(1), t * axis.get(2) * axis.get(2) - s
						* axis.get(0), t * axis.get(2) * axis.get(2) + c));
	}

	/**
	 * Create a new coordinate orthogonal coordinate system where the
	 * y-direction points into the newY-direction.
	 * 
	 * @param newY
	 ...
	 */
	public static IMatrix4 newIMatrix4(double i, double j, double k, double l,
			double m, double n, double o, double p, double q, double r,
			double s, double t, double u, double v, double w, double x) {
		return newIMatrix4(VectorMatrixFactory.newIVector4(i, j, k, l),
				VectorMatrixFactory.newIVector4(m, n, o, p),
				VectorMatrixFactory.newIVector4(q, r, s, t),
				VectorMatrixFactory.newIVector4(u, v, w, x));
	}
	...
	public static IMatrix4 newIMatrix4(IMatrix3 mat3) {
		return newIMatrix4(mat3.get(0, 0), mat3.get(0, 1), mat3.get(0, 2), 0,
				mat3.get(1, 0), mat3.get(1, 1), mat3.get(1, 2), 0,
				mat3.get(2, 0), mat3.get(2, 1), mat3.get(2, 2), 0, 0, 0, 0, 1);
	}
	...
	public static IMatrix4 makeTranslationMatrix(IVector3 translation) {
		...
		M.setRow(0, 3, translation.get(0));
		M.setRow(1, 3, translation.get(1));
		M.setRow(2, 3, translation.get(2));
		return M;
	}
