...
package cgresearch.graphics.datastructures.kd;
...
class HPoint implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3697710674014584247L;
	...
	public boolean equals(Object other) {
		if (!(other instanceof HPoint)) {
			return false;
		}
		HPoint p = (HPoint) other;
		return equals(p);
	}
