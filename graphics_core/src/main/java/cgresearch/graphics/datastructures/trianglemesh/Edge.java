 ...
 * Helper class for better performance with shadow volumes
 */
public class Edge {
    /**
     ...
     */
    private Triangle[] triangles = {null, null};
     ...
     *
     * @return true if triangle was added, false if this edge already has two triangles
     */
