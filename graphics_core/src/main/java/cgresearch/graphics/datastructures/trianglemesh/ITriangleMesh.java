...
public abstract class ITriangleMesh extends ICgNodeContent {
	 ...
	 */
	public abstract void addTriangle(Triangle t);
	 ...
	 */
	public abstract Triangle getTriangle(int index);
	...
	/**
	 * Add an additional texture coordinate, return index of the coordinate in
	 * the data structure.
	 * 
	 * @param texCoord3f
	...
	/**
	 * Unit the content of the second mesh (only vertices and triangles) from
	 * the second mesh with the this-mesh. The result is saved in the this-mesh.
	 */
