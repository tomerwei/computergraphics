...
public class MyMatrixTest {
  ...
  public void testMultiply() {
    IMatrix3 matrixA =
        VectorMatrixFactory.newIMatrix3(
            VectorMatrixFactory.newIVector3(1, 2, 1),
            VectorMatrixFactory.newIVector3(3, 4, 5),
            VectorMatrixFactory.newIVector3(-4, 4, 2));
  ...
  public void testTranspose() {
    IMatrix3 A =
        VectorMatrixFactory.newIMatrix3(
            VectorMatrixFactory.newIVector3(1, 2, 3),
            VectorMatrixFactory.newIVector3(4, 5, 6),
            VectorMatrixFactory.newIVector3(7, 8, 9));
    IMatrix3 B =
        VectorMatrixFactory.newIMatrix3(
            VectorMatrixFactory.newIVector3(1, 4, 7),
            VectorMatrixFactory.newIVector3(2, 5, 8),
            VectorMatrixFactory.newIVector3(3, 6, 9));
  ...
  public void testMultiplyMatrix() {
    IMatrix3 A = VectorMatrixFactory.newIMatrix3(1, 2, 3, 4, 5, 6, 7, 8, 9);
    IMatrix3 B =
        VectorMatrixFactory.newIMatrix3(0.5, 0.5, 0.5, 2, 2, 2, 1, 1, 1);
    IMatrix3 result = A.multiply(B);
    // System.out.println("A:\n" + A);
    // System.out.println("(B:\n" + (B);
    // System.out.println("A*(B:\n" + result);
    IMatrix3 expectedResult =
        VectorMatrixFactory.newIMatrix3(7.5, 7.5, 7.5, 18, 18, 18, 28.5, 28.5,
            28.5);
