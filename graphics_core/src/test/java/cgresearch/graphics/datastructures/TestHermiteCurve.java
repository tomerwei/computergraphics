...
public class TestHermiteCurve {
    ...
    @Test
    public void test2D() {
        Vector p0 = VectorMatrixFactory.newVector(-0.5, -0.5, 0);
        Vector p1 = VectorMatrixFactory.newVector(0.5, 0.5, 0);
        Vector m0 = VectorMatrixFactory.newVector(0, 1, 0);
        Vector m1 = VectorMatrixFactory.newVector(-1, 0, 0);
