...
public class PickingRenderer implements Observer {
	...
	private CgNode createCoordinateSystemNode() {
		...
		// X
		Arrow arrowX = new Arrow(VectorMatrixFactory.newVector(0, 0, 0),
				VectorMatrixFactory.newVector(0.3, 0, 0));
		...
		// Y
		Arrow arrowY = new Arrow(VectorMatrixFactory.newVector(0, 0, 0),
				VectorMatrixFactory.newVector(0, 0.3, 0));
		...
		// Z
		Arrow arrowZ = new Arrow(VectorMatrixFactory.newVector(0, 0, 0),
				VectorMatrixFactory.newVector(0, 0, 0.3));
		arrowZ.getMaterial().setReflectionDiffuse(
				VectorMatrixFactory.newVector(0, 0, 1));
