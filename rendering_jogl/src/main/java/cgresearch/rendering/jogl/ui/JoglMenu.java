...
public class JoglMenu extends CgApplicationMenu implements ActionListener {
  ...
  public JoglMenu() {
    ...
    menuItemTakeScreenshot.setActionCommand(JoglFrame.ActionCommands.ACTION_COMMAND_TAKE_SCREENSHOT.toString());
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    } else if (e.getActionCommand().equals(JoglFrame.ActionCommands.ACTION_COMMAND_TAKE_SCREENSHOT.toString())) {
      Logger.getInstance().error("Screenshot export currently not supported.");
    }
  }
