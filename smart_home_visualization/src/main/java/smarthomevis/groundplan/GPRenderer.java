...
public class GPRenderer {
  ...
  private ITriangleMesh render3DMeshWindow(ITriangleMesh mesh, GPLine l) {
    ...
    IVector3 bottomWindowStart =
        new Vector3(start.get(0), start.get(1), start.get(2) + this.data.getWindowBottomHeight());
    IVector3 bottomWindowEnd = new Vector3(end.get(0), end.get(1), end.get(2) + this.data.getWindowBottomHeight());

    IVector3 topWindowStart = new Vector3(start.get(0), start.get(1), start.get(2) + this.data.getWindowTopHeight());
