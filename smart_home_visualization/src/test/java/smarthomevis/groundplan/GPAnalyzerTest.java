...
public class GPAnalyzerTest
{
	...
	{
	GPLine line = new GPLine("line1", new Vector3(3.0, 0.5, 0.0),
		new Vector3(1.0, 0.5, 0.0));
	GPLine other = new GPLine("line2", new Vector3(0.5, 1.5, 0.0),
		new Vector3(2.0, 1.5, 0.0));
	...
	{
	GPLine line = new GPLine("line1", new Vector3(0.5, 0.5, 0.0),
		new Vector3(2.5, 1.0, 0.0));
	GPLine other = new GPLine("line2", new Vector3(1.0, -0.5, 0.0),
	...
	{
	GPLine line = new GPLine("line1", new Vector3(1.0, 1.5, 0.0),
		new Vector3(1.0, 2.5, 0.0));
	GPLine other = new GPLine("line2", new Vector3(2.0, 0.5, 0.0),
		new Vector3(2.0, 3.0, 0.0));
	...
	{
	GPLine line1 = new GPLine("line1", new Vector3(0.0, 0.0, 0.0),
		new Vector3(0.0, 2.0, 0.0));
	GPLine line2 = new GPLine("line2", new Vector3(2.35, 0.0, 0.0),
		new Vector3(2.35, 2.0, 0.0));
	...
	{
	GPLine line1 = new GPLine("line1", new Vector3(-1.32, 0.9, 0.0),
		new Vector3(4.32, 0.9, 0.0));
	GPLine line2 = new GPLine("line2", new Vector3(-3.4535, -0.1, 0.0),
		new Vector3(-0.87, -0.1, 0.0));
